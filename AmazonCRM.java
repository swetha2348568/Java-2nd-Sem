...
public class AmazonCRM {
    ...
    public static void main(String[] args) {
        ...
        Customer customer1 = new Customer(100, "swetha", 560042);
        Customer customer2 = new Customer(101, "visa", 560042);

        Product product1 = new Product(666, "Inspirion");
        Product product2 = new Product(888, "Dell");
